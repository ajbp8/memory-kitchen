  ...
  return (
    <div className="rounded-xl border p-4" style={{ borderColor: "var(--mk-border)", background: "white" }}>
      ...
      <button
        ...
        className="w-full rounded-xl py-2.5 text-sm font-bold text-white mb-2 flex items-center justify-center gap-2"
      ...
      <button
        ...
        style={{
          background: status === "copied" ? "rgba(6,81,48,0.08)" : "rgba(0,0,0,0.04)",
          color: status === "copied" ? "#065130" : "#666",
